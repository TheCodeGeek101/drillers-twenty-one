    ...
    <footer class="bg-stone-900">
        <div class="container px-6 py-8 mx-auto">
            ...
            <a href="#" class="text-2xl font-bold text-gray-800 text-yellow-300 hover:text-gray-700 font-custom dark:hover:text-gray-300">Drillers 21 </a>

            <p class="max-w-md mx-auto mt-2 text-gray-500 dark:text-gray-400">Stay tuned for more drill music</p>
            ...
            <p class="text-sm text-gray-400">Drillers 21 © Copyright 2022. All Rights Reserved.</p>
